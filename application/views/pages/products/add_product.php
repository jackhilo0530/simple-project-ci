                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select id="productCategory" name="category_id" required
                                    ...
                                    <option value="1" <?php echo set_select('category_id', '1'); ?>>Electronics</option>
                                    <option value="2" <?php echo set_select('category_id', '2'); ?>>Clothing</option>
                                    <option value="3" <?php echo set_select('category_id', '3'); ?>>Home Goods</option>
                                </select>
                            </div>
                        </div>
                    </div>
